...
class Gbfs(BikeShareSystem):
    ...
    def update(self, scraper=None):
        ...
        self.entities = list(self.parse_vehicles(feral_bikes, vehicles))
...
class GbfsVehicle(Vehicle):
    ...
    def update_normal_bikes(self, vehicle, info):
        self.vehicle_type = VehicleTypes.bicycle

    def update_ebikes(self, vehicle, info):
        self.vehicle_type = VehicleTypes.ebike
    ...
    def update_scooter(self, vehicle, info):
        self.vehicle_type = VehicleTypes.scooter
